...
<main class="site-main">
   <?php getHeroSection(); ?>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                if ($featured_posts->have_posts()):
                    while ($featured_posts->have_posts()):
                        ...
                        $category_name = !empty($categories)
                            ? strtoupper($categories[0]->name)
                            : "FEATURED";
                        $category_emoji = !empty($categories)
                ...
                <article class="group cursor-pointer">
                    <a href="<?php the_permalink(); ?>">
                        <div class="h-48 rounded-lg mb-4 flex items-center justify-center overflow-hidden <?php echo $has_thumbnail
                            ? ""
                            : "bg-gradient-to-br from-blue-600 to-blue-800"; ?>" <?php echo $has_thumbnail
    ...
    : ""; ?>>
                        ...
                        <div class="text-xs text-bsj-gold font-bold mb-2"><?php echo esc_html(
                            $category_name,
                        ); ?></div>
                        ...
                        <div class="text-sm text-gray-500"><?php echo $read_time; ?> min read • <?php echo get_the_date(
     "M j, Y",
 ); ?></div>
                    </a>
                </article>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            if (!empty($categories)):
                foreach ($categories as $category):
                    ...
                    $category_description = wp_strip_all_tags(
                ...
                <a href="<?php echo get_category_link($category->term_id); ?>">
                    <div class="bg-white p-6 rounded-lg border-2 border-transparent hover:border-bsj-gold transition cursor-pointer text-center">
                        ...
                        <h3 class="font-bold text-bsj-navy mb-2"><?php echo esc_html(
                            $category->name,
                        ); ?></h3>
                        <p class="text-sm text-gray-600"><?php echo esc_html(
                            $category_description ?: "Category posts",
                        ); ?></p>
                    </div>
                </a>
                <?php

...
<?php while (have_posts()):
  ...
  if ($news) {
      ...
      foreach ($news as $news_item) {
          ...
          if (is_object($news_item) && isset($news_item->ID)) {
              ...
              $news_image = get_the_post_thumbnail($news_id, "medium", [
  ...
  if ($sponsors) {
      ...
      foreach ($sponsors as $sponsor) {
          ...
          if ($sponsor_id) {
              $sponsor_image = get_the_post_thumbnail($sponsor_id, "medium", [
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-4 mb-6">
          <!-- <a href="<?php echo get_post_type_archive_link(
              "athlete",
          ); ?>" class="text-bsj-gold hover:text-yellow-400 transition flex items-center gap-2">
        ...
        <div class="grid md:grid-cols-3 gap-8 items-start">
            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <?php else: ?>
                <div class="w-full aspect-square bg-gray-700 rounded-lg flex items-center justify-center">
                  <span class="text-6xl font-bold text-gray-500"><?php echo strtoupper(
          ...
          <div class="md:col-span-2">
            ...
            <div class="flex flex-wrap items-center gap-4 mb-6">
              ...
              <?php if ($class_year): ?>
                <span class="text-gray-300 text-lg"><?php echo esc_html(
                    $class_year,
                ); ?></span>
              <?php endif; ?>
            ...
            <?php if ($school_id): ?>
              <div class="flex items-center gap-3 mb-6">
                <?php
                $school_logo = get_the_post_thumbnail($school_id, "thumbnail", [
                ...
                <?php if ($school_permalink): ?>
                  <a href="<?php echo esc_url(
                      $school_permalink,
                  ); ?>" class="text-xl font-semibold hover:text-bsj-gold transition">
                    <?php echo esc_html($school_name); ?>
                  </a>
                <?php else: ?>
                  <span class="text-xl font-semibold"><?php echo esc_html(
                      $school_name,
                  ); ?></span>
                <?php endif; ?>
              </div>
            ...
            <?php if ($high_school): ?>
              <div class="text-gray-300 mb-2">
                ...
                <?php if ($high_school_location): ?>
                  <span class="text-gray-400">(<?php echo esc_html(
                ...
                <div class="text-3xl font-bold">
                  <?php if (is_numeric($nil_valuation)) {
                      if ($nil_valuation >= 1000000) {
                          echo '$' .
                              number_format($nil_valuation / 1000000, 1) .
                              "M";
                      } elseif ($nil_valuation >= 1000) {
                          echo '$' .
                              number_format($nil_valuation / 1000, 0) .
                              "K";
                      } else {
                    ...
                    <article class="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                      <a href="<?php echo esc_url(
                        ...
                        <div class="md:flex">
                          ...
                          <?php endif; ?>
                          <div class="<?php echo $news_post["image"]
                              ? "md:w-2/3"
                              : "w-full"; ?> p-6">
            ...
            <div class="space-y-6">
                      ...
                      <div class="flex items-center gap-3 p-3 bg-white rounded-lg border border-gray-200 hover:border-bsj-gold transition">
                        ...
                        <div class="flex-1 min-w-0">
                          <?php if ($sponsor["permalink"]): ?>
                            <a href="<?php echo esc_url(
                                $sponsor["permalink"],
                            ); ?>" class="font-semibold text-bsj-navy hover:text-bsj-blue transition block">
                              <?php echo esc_html($sponsor["name"]); ?>
                            </a>
                          <?php else: ?>
                            <span class="font-semibold text-bsj-navy"><?php echo esc_html(
                                $sponsor["name"],
                            ); ?></span>
                          <?php endif; ?>
                        </div>
                ...
                <dl class="space-y-3">
                  <?php if ($position): ?>
                    <div class="flex justify-between">
                      ...
                      <dd class="font-semibold text-bsj-navy"><?php echo esc_html(
                          $position,
                      ); ?></dd>
                    </div>
                  <?php endif; ?>
                  ...
                  <?php if ($high_school): ?>
                    <div class="flex justify-between">
                      ...
                      <dd class="font-semibold text-bsj-navy text-right"><?php echo esc_html(
                          $high_school,
                      ); ?></dd>
                    </div>
                  <?php endif; ?>
              ...
              <div class="bg-bsj-navy rounded-lg p-6 text-white">
                ...
                <div class="flex gap-3">
                  <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode(
                      get_the_title(),
      ...
      <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <?php while ($related_athletes->have_posts()):
                $related_athletes->the_post(); ?>
              <article class="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-lg transition-shadow">
                <a href="<?php the_permalink(); ?>" class="block">
                  ...
                  <?php if (get_field("position")): ?>
                    <p class="text-sm text-gray-600 mt-1"><?php the_field(
                        "position",
                    ); ?></p>
                  <?php endif; ?>
                </a>
